...
<head>
    ...
    <meta name="copyright" content="SYE DECODIFICACIONES">
    ...
    <script src="<?php echo base_url();?>web-app/js/jquery-3.5.1.min.js"></script>
    <script src="<?php echo base_url();?>web-app/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url();?>web-app/js/popper.min.js"></script>
    
    <script src="<?php echo base_url();?>web-app/js/slider/jquery.min.js"></script>
    <script src="<?php echo base_url();?>web-app/js/slider/jquery.mobile.customized.min.js"></script>
    <script src="<?php echo base_url();?>web-app/js/slider/jquery.easing.1.3.js"></script> 
    <script src="<?php echo base_url();?>web-app/js/slider/camera.min.js"></script>
